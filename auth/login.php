...
session_start();
if ($_SESSION['auth']) {
    $_SESSION['message'] = "Logout to access Login Page";
...
if (isset($_POST['Submit'])) {
    ...
    if ($msg != null) {
        ...
        $result = $crud->getData("SELECT * FROM auth WHERE email = '$email' AND password = '$encrypt_password'");
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $_SESSION['message'] = ucfirst(strtolower($user_name)) . ", you are logged in";
            header('location: ../index.php');
        }
    }
} else {
